...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-4xl font-bold tracking-tighter text-primary tracking-wide">{text}</span>
      ...
      >
        ...
        >
          <span className="text-4xl font-bold tracking-tighter text-background whitespace-nowrap tracking-wide">
            {hoverText}
          </span>
        </div>
      </div>
