...
export const InfiniteGrid = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full h-full min-h-full flex flex-col items-center justify-center overflow-hidden bg-background",
        className
      )}
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 w-full mx-auto space-y-6">
        {children}
      </div>
    </div>
  );
